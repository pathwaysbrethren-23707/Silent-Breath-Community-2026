...
# 🎮 SILENT BREATH — Community Edition

**Psychological horror where staying silent is survival.**
...
SILENT BREATH is a first-person psychological horror game built in Unreal Engine 5, where the game listens to you through your microphone and an adaptive AI studies your reactions to craft personalized scares. Explore a dark, atmospheric forest, search for missing people, and above all — stay silent. This Community Edition is a standalone, self-contained package: no storefront required, no additional software needed, and ready to play immediately after extraction.

For horror enthusiasts on Windows PC who want a fully offline, self-contained psychological horror experience with microphone-based gameplay.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2796180/ss_26c820129bed79da97681693b78923dc7d836043.1920x1080.jpg?t=1787570009" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2796180/ss_074e0f8a7a114fd0a8268fc9a8f036859c391393.1920x1080.jpg?t=1787570009" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2796180/ss_f77511ddc833fc42ac61eb26c915ef7e3062fdd3.1920x1080.jpg?t=1787570009" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🎙️ **Microphone Detection** — The game hears you — screaming or audible fear has real consequences.
- 🧠 **Adaptive AI Antagonist** — An AI-driven entity learns your fears and tailors scares to you personally.
- 🌲 **Forest Exploration** — Search a dense, foreboding forest for missing people using photos as clues.
- 😱 **Psychological Tension** — Constant dread, jump scares, and an atmosphere designed to break your composure.
- 🎞️ **Unreal Engine 5 Visuals** — Photorealistic environments with dynamic lighting for maximum immersion.
- 🎧 **Immersive Audio** — Detailed 3D sound design — headphones strongly recommended.
- 📦 **Standalone Package** — Fully offline independent release — no storefront required, no additional software.
- 💾 **All Content Included** — Complete game experience in one self-contained build.
...
| **Processor** | Intel Core i5-8400 / AMD Ryzen 5 1600 | Intel Core i7-9700 / AMD Ryzen 7 3700X |
| **RAM** | 8 GB | 16 GB |
| **Graphics** | NVIDIA GeForce GTX 1060 6 GB | NVIDIA GeForce RTX 2070 / RTX 3060 |
| **Storage** | 20 GB available space | 20 GB available space (SSD) |
| **Additional** | Microphone required (core gameplay mechanic) | Microphone and headphones recommended for full experience |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\SILENTBREATH\Saved`
